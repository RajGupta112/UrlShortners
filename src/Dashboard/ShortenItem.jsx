...
import { useStoreContext } from '../../src/context/ContextApi';
...
const ShortenItem = ({ originalUrl, shortUrl, clickCount, createdDate }) => {
    ...
    const baseUrl = import.meta.env.VITE_REACT_FRONT_END_URL?.replace(/\/$/, '') || '';
    ...
    return (
        <div className={`bg-white shadow-lg border border-dotted border-slate-500 px-6 sm:py-1 py-3 rounded-md transition-all duration-100`}>
            <div className={`flex sm:flex-row flex-col sm:justify-between w-full sm:gap-0 gap-5 py-5`}>
                <div className="flex-1 sm:space-y-1 max-w-full overflow-x-auto overflow-y-hidden">
                    ...
                    <div className="flex items-center gap-1">
                        <h3 className="text-slate-700 font-[400] text-[17px] truncate">
                            {originalUrl}
                        </h3>
                    </div>
                ...
                <div className="flex flex-1 sm:justify-end items-center gap-4">
                    <CopyToClipboard
                        ...
                        text={fullShortUrl}
                    >
                        <div className="flex cursor-pointer gap-1 items-center bg-black py-2 font-semibold shadow-md shadow-slate-500 px-6 rounded-md text-white">
